---
sidebar_position: 4
sidebar_label: Исключения Git
title: Настройка исключений Git
---
...
Полная очистка и повторное применение `.gitignore`:
...
- Внешние обработки (`.epf`) — хранить исходники или бинарные файлы
