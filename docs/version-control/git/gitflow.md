...
Сообщения коммитов оформляйте по [соглашению о коммитах](../README.md#соглашение-о-коммитах).

При слиянии используйте `--no-ff`, чтобы сохранить точку слияния в графе истории.

Для доработанных конфигураций, обновляемых на новые релизы поставщика, используется дополнительная долгоживущая ветка-«зеркало вендора» — см. [Обновление от вендора](vendor-update.md).
