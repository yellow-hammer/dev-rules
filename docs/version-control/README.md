...
2. **Делайте атомарные коммиты** — не накапливайте несвязанные изменения. Каждый коммит должен решать одну задачу
3. **Пишите понятные описания** — с точки зрения пользователя, не разработчика
4. **Указывайте номер задачи** — для связи с системой управления задачами (кроме gitflow)
