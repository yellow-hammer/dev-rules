...
- System - наименование информационной системы (Enterprise20, Retail30, Accounting30 etc), согласно наименованию продукта на [сайте 1С](https://release.1c.ru/). Возможны сокращения до абревиатуры (Например cpm, erp, acc etc).
