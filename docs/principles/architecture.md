...
- Неверно: «Не проводить заказ при долге > кредитного лимита»
- Неверно: «Скидка > 15% требует утверждения»
...
- Обработчики команд формы, HTTP-обработчики, регламентные задания
...
- Приемлема, когда центр тяжести в домене, а не в БД/framework
...
- **Микросервисы / SOA / SCS** — модели развёртывания и интеграции
...
- **Actor/Reactive** — модель конкурентности и среды выполнения
...
### 7. Общие модули-одиночки вместо инъекции
