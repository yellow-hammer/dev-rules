...
Её ещё называют предпромышленной средой. Здесь используются данные из последнего backup'а системы на prod-сервере, чтобы максимально проверить работоспособность и стабильность приложения или сервиса. Эта среда максимально приближена к тому, что видят перед собой конечные пользователи.
