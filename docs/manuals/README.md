...
### [Жизненный цикл задачи](task-lifecycle.md)

Порядок движения задачи от постановки до закрытия. Включает:

- роли аналитика, разработчика, проверяющего, тестирования, UAT и переноса
- критерии готовности задачи к разработке
- правила возврата задачи на доработку
