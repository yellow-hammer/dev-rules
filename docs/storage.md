...
2. Не смешивайте типы изменений (например, изменение в отчете по остаткам и документа платежное поручение)
3. Используйте scope для указания области (Бюджетирование, Администрирование, Интеграция, Казначейство)
4. Описание на русском языке, краткое и понятное
