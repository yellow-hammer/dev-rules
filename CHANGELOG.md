...
- **glossary:** Удален глоссарий терминов из документации

- **version-control:** Добавили методичку обновления от вендора
...
- **site:** Добавлена ссылка DeepWiki в навигацию

- **site:** Добавлена форма обратной связи на страницах

- **theme:** Обновлены темы подсветки синтаксиса и стили для тёмной темы


### 📚 Documentation

- **tasks:** Обновлена навигация и жизненный цикл задачи

- Дополнены стандарты разработки

- Унифицирована структура страниц документации

- **nav:** Добавлена структура разделов документации

- **changelog:** Исправлены опечатки в документации

- **git:** Обновление документации по Git
...
- **users:** Обновлен раздел о пользователях с информацией о типах учетных записей и требованиях к идентификации

- **cursor:** Добавлен файл .cursorignore и обновлены правила для проекта

- **vscode:** Исправлены таблицы с расширениями и их описаниями

- **manuals:** Временно закомментирован раздел о пользовании руководствами

- Добавлены новые значки для чата в Telegram и Devin в README.md

- Обновлено название значка Ask Devin на Ask DeepWiki в README.md

- **README:** Обновлена ссылка на поддержку автору

- **git:** Добавлены рекомендации по стилю и создан файл .gitattributes

- Обновление ссылок в документацие

- **cursor:** Добавлены правила документации и технические ограничения

- Обновление документации по расширениям, формам, оформлению, запросам и интеграциям

- **cicd:** Обновление раздела CI/CD
...
- **rabbitmq:** Удален устаревший файл с примерами использования БИТ.Адаптера
